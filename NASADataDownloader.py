...
if __name__ == "__main__":
    yearlist = [2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017,2018]
    julianDays = [1,366] #第一个为开始日期，第二个为结束日期
    hvs =[[26,5]]
    outpath = "E:\code\python\caa"
    GetProductData(mainUrl,"MOD11A2",yearlist,julianDays,hvs,outpath)